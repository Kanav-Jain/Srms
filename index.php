...
<head>
  ...
  <link rel="stylesheet" href="../Srms/css/navbar.css" />

  <link rel="stylesheet" href="../Srms/css/index.css" />

  <link rel="stylesheet" href="../Srms/css/footer.css" />
...
<body>
  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #1545b3 !important;">
    <a class="navbar-brand mainTitle" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="../Srms/index.php">Home</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="../Srms/php/scoreboard.php">Scoreboard</a>
        </li>
  ...
  <section>
    ...
    <div class="container-fluid">
      <table class="table jumbotron">
        <h4 align="center">Students with Maximum Marks!</h4>
        <div class="row">
          <div class="col">
            <tr>
              <th>Reg No</th>
  ...
  $query = "Select * from `student_info` where `total` = (select max(`total`) from `student_info`)";
...
?>
      ...
      <div style="padding: 3.4rem;" class="space"></div>
      <table class="table jumbotron">
        <h4 align="center">Students with Maximum Attendance!</h4>
        <div class="row">
          <div class="col">
            <tr>
              <th>Reg No</th>
        ...
        <?php
  $conn = mysqli_connect("localhost", "student", "root", "srms", 3307);
  $query = "Select * from `student_info` where `attendance` = (select max(`attendance`) from `student_info`)";
  $result = mysqli_query($conn, $query);
  while($row = mysqli_fetch_assoc($result)){
    echo "<tr>
        <td>".$row['regno']."</td>
